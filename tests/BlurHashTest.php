...
final class BlurHashTest extends TestCase
{
    ...
    {
        $blurHash = Image::wrap(__DIR__.'/Fixture/files/symfony.jpg')->blurHash();
    ...
    {
        $dataUri = Image::wrap(__DIR__.'/Fixture/files/symfony.jpg')->blurHash()->dataUri();
        ...
        $image = Image::from(\base64_decode(\mb_substr($dataUri, 23)));
